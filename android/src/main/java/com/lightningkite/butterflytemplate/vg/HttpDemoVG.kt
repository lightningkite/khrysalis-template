...
class HttpDemoVG(
    ...
    override fun generate(dependency: ActivityAccess): View {
        ...
        //--- Call
        val obs = HttpClient.callWithProgress("https://jsonplaceholder.typicode.com/posts/", parse = { it.readJson<List<Post>>() })

        //--- Set Up xml.progress
        xml.progress.bindFloat(obs.map { it.approximate }.asObservableProperty(0f))
