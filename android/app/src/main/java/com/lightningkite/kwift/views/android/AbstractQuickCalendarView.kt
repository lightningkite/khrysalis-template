...
abstract class AbstractQuickCalendarView : LinearLayout {
    ...
    val childAttributeSet: AttributeSet?

    constructor(context: Context) : super(context) {
        childAttributeSet = null
        init()
    }

    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        childAttributeSet = attrs
        init()
    }

    abstract fun makeChildView(): QuickMonthView
    open val ignoreDragOnDay: Boolean get() = true
