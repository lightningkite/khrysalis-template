...
public class FormField<T>: UntypedFormField {
    ...
    public init(name: ViewString, observable: StandardObservableProperty<T>, validation: @escaping (UntypedFormField) -> ViewString?
        ...
        self.error = StandardObservableProperty(nil)
    }
...
public class Form {
    ...
    public func field<T>(_ name: ViewString, _ defaultValue: T, _ validation: @escaping (FormField<T>) -> ViewString?) -> FormField<T> {
