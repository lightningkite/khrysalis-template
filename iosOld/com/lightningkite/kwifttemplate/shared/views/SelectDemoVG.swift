...
public class SelectDemoVG: ViewGenerator {
    ...
    public init(stack: ObservableStack<ViewGenerator>) {
        self.stack = stack
        self.options = [ControlsDemoVG(stack), ExampleContentVG(), ViewPagerDemoVG(stack), SegmentedControlDemoVG(), SliderDemoVG(), WeekDemoVG(), DateRangeDemoVG(), LoginDemoVG(stack)]
        super.init()
    }
