...
import { Shader, newLinearGradient } from 'butterfly-web/dist/views/draw/LinearGradient'
import { numberToColor } from 'butterfly-web/dist/views/Colors'
import { pathFromLTRB, pathOvalFromLTRB } from 'butterfly-web/dist/views/draw/Path'
