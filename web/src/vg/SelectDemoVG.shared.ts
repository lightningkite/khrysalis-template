...
export class SelectDemoVG extends ViewGenerator implements EntryPoint {
    ...
    public constructor(stack: ObservableStack<ViewGenerator>) {
        super();
        this.options = [new WebsocketDemoVG(), new HttpDemoVG(), new ExternalTestVG(), new PongDemoVG(), new FloatingHexagonsDemoVG(), new MarginTestsVG(), new MultipleDemoVG(), new DateButtonDemoVG(), new LocationDemoVG(), new LoadImageDemoVG(), new ControlsDemoVG(), new ExampleContentVG(), new ViewPagerDemoVG(stack), new SegmentedControlDemoVG(), new SliderDemoVG(), new DateRangeDemoVG(), new LoginDemoVG(stack), new DrawableDemoVG(), new PreviewVG()];
    }
    
    public readonly stack: (ObservableStack<ViewGenerator> | null);
    ...
    public generate(dependency: Window): HTMLElement {
        ...
        androidxRecyclerviewWidgetRecyclerViewBind(xml.list, new ConstantObservableProperty(this.options), this.options[0], (obs) => {
                ...
                xml.button.addEventListener("onclick", (_ev) => { _ev.stopPropagation(); 
