...
export class HttpDemoVG extends ViewGenerator {
    ...
    public generate(dependency: Window): HTMLElement {
        ...
        //--- Set Up xml.items
        androidxRecyclerviewWidgetRecyclerViewBind<HttpDemoVG.Post>(xml.items, ioReactivexObservableAsObservableProperty<(Array<HttpDemoVG.Post> | null)>(ioReactivexSingleReadJson<Array<HttpDemoVG.Post>>(HttpClient.INSTANCE.call("https://jsonplaceholder.typicode.com/posts/", undefined, undefined, undefined), [Array, [HttpDemoVG.Post]]), [new HttpDemoVG.Post(0, 0, "Loading...", "-")]), new HttpDemoVG.Post(0, 0, "Default", "Failure"), (observable: ObservableProperty<HttpDemoVG.Post>): HTMLElement => {
                ...
                androidWidgetTextViewBindString(cellXml.label, comLightningkiteKhrysalisObservablesObservablePropertyMap<HttpDemoVG.Post, string>(observable, (it: HttpDemoVG.Post): string => it.title));
