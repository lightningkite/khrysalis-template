...
export namespace R {
    ...
    export interface Strings {
        ...
        ok: string;
        cancel: string;
        welcome_to_switch_town: string;
        i_m_a_switch: string;
        go_to_another_screen: string;
        you_made_it_to_another_screen: string;
        welcome: string;
        ...
        camera: string;
        get_location: string;
        check_out_my_multiple_rows: string;
        lorem_ipsum: string;
        lorem_pixel: string;
        connect: string;
    ...
    export namespace DefaultStrings {
        ...
        export const welcome_to_switch_town: string = "Welcome to Switch Town!";
        export const i_m_a_switch: string = "I\'m a switch!";
        ...
        export const get_location: string = "Get Location";
        export const check_out_my_multiple_rows: string = "Check out my multiple rows";
        export const lorem_ipsum: string = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. ";
