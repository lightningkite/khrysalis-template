...
static func icAndroidBlack24dp(_ view: UIView? = nil) -> CALayer {
    ...
    layer.addSublayer({
        ...
        //s 1.5, -0.67, 1.5, -1.5
        path.addCurve(to: CGPoint(x: 11.0 * scaleX, y: 22.5 * scaleY), control1: CGPoint(x: 8.67 * scaleX, y: 24.0 * scaleY), control2: CGPoint(x: 11.0 * scaleX, y: 23.33 * scaleY))
        //L 11.0, 19.0
        ...
        //s 1.5, -0.67, 1.5, -1.5
        path.addCurve(to: CGPoint(x: 16.0 * scaleX, y: 22.5 * scaleY), control1: CGPoint(x: 13.67 * scaleX, y: 24.0 * scaleY), control2: CGPoint(x: 16.0 * scaleX, y: 23.33 * scaleY))
        //L 16.0, 19.0
        ...
        path.addCurve(to: CGPoint(x: 5.0 * scaleX, y: 16.5 * scaleY), control1: CGPoint(x: 2.67 * scaleX, y: 18.0 * scaleY), control2: CGPoint(x: 5.0 * scaleX, y: 17.33 * scaleY))
        //v -7.0
        ...
        //s 1.5, -0.67, 1.5, -1.5
        path.addCurve(to: CGPoint(x: 22.0 * scaleX, y: 16.5 * scaleY), control1: CGPoint(x: 19.67 * scaleX, y: 18.0 * scaleY), control2: CGPoint(x: 22.0 * scaleX, y: 17.33 * scaleY))
        //v -7.0
