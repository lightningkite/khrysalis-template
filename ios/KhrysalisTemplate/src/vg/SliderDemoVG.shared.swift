...
public class SliderDemoVG : ViewGenerator {
    ...
    override public func generate(dependency: ViewDependency) -> View {
        ...
        xml.ratingDisplayNumber.bindText(observable: self.obsRatingInt, transform: { (it) -> String in String(describing: it) })
        ...
        xml.ratingDisplayNumberFloat.bindText(observable: self.obsRatingFloat, transform: { (it) -> String in String(describing: it) })
