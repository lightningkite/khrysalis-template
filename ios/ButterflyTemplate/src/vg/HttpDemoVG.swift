// File: /home/jivie/Projects/khrysalis-template/android/src/main/java/com/lightningkite/butterflytemplate/vg/HttpDemoVG.kt
...
public class HttpDemoVG : ViewGenerator {
    ...
    override public func generate(dependency: ViewControllerAccess) -> UIView {
        ...
        //--- Call
        let call = HttpClient.INSTANCE.callWithProgress(url: "https://jsonplaceholder.typicode.com/posts/", parse: { (it) -> Single<Array<HttpDemoVG.Post>> in (it.readJson() as Single<Array<HttpDemoVG.Post>>) })
        
        //--- Set Up xml.progress
        xml.progress.bindFloat(observable: call.map({ (it) -> Float in it.approximate }).asObservableProperty(defaultValue: 0))
