...
public enum R {
    ...
    public enum string {
        ...
        static let app_name = NSLocalizedString("Butterfly Template", comment: "app_name")
        ...
        static let welcome_message = NSLocalizedString("This is the template for a Butterfly project. This screen exists to help you figure out stuff about it.", comment: "welcome_message")
